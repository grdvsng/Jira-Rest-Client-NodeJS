/**
 * JiraClient module.
 * @module    bin/JiraClient
 * @author:   Trishkin Sergey <grdvsng@gmail.com>
 */
...
const btoa =
     ...
     * @returns {string}
     */
    (data) => { return Buffer.from(data).toString('base64') };
...
const atob =
     ...
     * @returns {string}
     */
    (data) => { return Buffer.from(data, 'ascii').toString('utf8') };

/** 
 * Inner Errors diction.
 * @constant
 * @type {Array.<{\
        type: String, 
